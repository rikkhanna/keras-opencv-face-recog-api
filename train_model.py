...
train_image_generator = ImageDataGenerator(
    rescale=1./255, horizontal_flip=True, preprocessing_function=preprocess_input)  # Generator for our training data
...
model.save("face_detector/face_recognizer_model.h5")
